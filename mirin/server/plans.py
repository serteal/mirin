"""Compiled interpretability plans for the inference server."""
...
class MapSpec:
    """Serializable description of a built-in server map op."""
...
@dataclass(frozen=True, slots=True)
class OutputPolicy:
    """Narrow result selection for server execution."""
...
def compile_plan(
    ...
    *,
    ...
    """Compile user-facing paths or proxies into a fixed server plan."""
